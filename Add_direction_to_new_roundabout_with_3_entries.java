 ...
 * @author KAU
 */
public class Add_direction_to_new_roundabout_with_3_entries extends javax.swing.JFrame {
    String id = "";
    /**
     * Creates new form Add_direction_to_new_roundabout
     */
    public Add_direction_to_new_roundabout_with_3_entries() {
        initComponents();
        initFirebase();
    }

    public Add_direction_to_new_roundabout_with_3_entries(String user_id) {
        initComponents();
        initFirebase();
        id = user_id;
        jLabel6.setText("User ID: " + user_id);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\KAU\\Desktop\\roundabout in 2D\\miniroundabout-with 3 exits.jpg")); // NOI18N

        jLabel2.setText("please specify where the flow coming from in each direction:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel3.setText("Street 1:");

        jLabel4.setText("Street 2:");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel5.setText("Street 3:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_direction_to_new_roundabout_with_3_entries.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_direction_to_new_roundabout_with_3_entries().setVisible(true);
            }
        });
    }
